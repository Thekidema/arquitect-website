...
src/assets/        ← Todo: CSS, JS, imágenes, datos
...
```
hero/         → Las 3 imágenes grandes del carrusel
projects/     → Las 6 imágenes del portfolio
```

Reemplaza los SVG con tus propias imágenes (JPG, PNG, WebP).
...
- `ARCHITECTURE.md` → Por qué está hecho así
...
- `optimize-images.js` → Para comprimir imágenes
...
public/index.html
    ↓ linkea
../src/assets/css/variables.css   ← Todos los colores vienen de acá
